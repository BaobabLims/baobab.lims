...
class CultureMediumsView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.contentFilter = {
            'portal_type': 'CultureMedium',
        }
        self.context_actions = {_('Add'):
                                    {'url': 'createObject?type_name=CultureMedium',
                                     'icon': '++resource++bika.lims.images/add.png'}}
        self.title = self.context.translate(_("Culture Mediums"))
        ...
        if self.context.portal_type == 'CultureMedium':
