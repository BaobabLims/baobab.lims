...
class SampleKingdomsView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.contentFilter = {
            'portal_type': 'SampleKingdom',
        }
        self.context_actions = {_('Add'):
                                    {'url': 'createObject?type_name=SampleKingdom',
                                     'icon': '++resource++bika.lims.images/add.png'}}
        self.title = self.context.translate(_("Sample Kingdoms"))
        ...
        if self.context.portal_type == 'SampleKingdoms':
    ...
    def folderitems(self, full_objects=False):
        ...
        for x in range(len(items)):
            ...
            # items[x]['DateCreation'] = obj.getField('DateCreation').get(obj)
            items[x]['Description'] = obj.Description()
            # items[x]['Kingdom'] = obj.getField('Kingdom').get(obj)
