...
class VolumeUnitsView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.contentFilter = {
            'portal_type': 'VolumeUnit',
        }
        self.context_actions = {_('Add'):
                                    {'url': 'createObject?type_name=VolumeUnit',
                                     'icon': '++resource++bika.lims.images/add.png'}}
        self.title = self.context.translate(_("Volume Units"))
        ...
        if self.context.portal_type == 'VolumeUnit':
