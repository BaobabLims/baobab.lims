...
class MonitoringDevicesView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.contentFilter = {
            'portal_type': 'MonitoringDevice',
        }
        self.context_actions = {_('Add'):
                                    {'url': 'createObject?type_name=MonitoringDevice',
                                     'icon': '++resource++bika.lims.images/add.png'}}
        self.title = self.context.translate(_("Monitoring Devices"))
        ...
        if self.context.portal_type == 'MonitoringDevices':
