...
class SamplePackagesView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.contentFilter = {
            'portal_type': 'SamplePackage',
        }
        self.context_actions = {_('Add'):
                                    {'url': 'createObject?type_name=SamplePackage',
                                     'icon': '++resource++bika.lims.images/add.png'}}
        self.title = self.context.translate(_("Sample Packages"))
        ...
        if self.context.portal_type == 'SamplePackage':
