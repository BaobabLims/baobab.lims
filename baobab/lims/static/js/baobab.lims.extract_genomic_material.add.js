function ExtractGenomicMaterialAddView(){
    ...
    function addExtractGenomicMaterialSaveAndCancelButtons(EGM){
        var div = $(EGM);
        var buttons = '\
            <div class="savecancel_extract_genomic_material_buttons">\
                ...
                <button class="cancel-extract-genomic-material" name="form.button.cancel">Cancel Extract</button>\
            </div>\
        ';
        $(div).append(buttons);
        ...
        $('.cancel-extract-genomic-material').click(function(event){
            event.preventDefault();
