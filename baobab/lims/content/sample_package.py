...
from baobab.lims.interfaces import ISamplePackage
...
class SamplePackage(BaseContent):
    security = ClassSecurityInfo()
    implements(ISamplePackage, IConstrainTypes)
...
registerType(SamplePackage, config.PROJECTNAME)