...
from baobab.lims.interfaces import IReCulturing
...
DateOfReplication = DateTimeField(
    'DateOfReplication',
    ...
    widget=DateTimeWidget(
        label=_("Date Of Replication"),
        description=_("Date Of Replication."),
        # show_time=True,
        visible={'edit': 'visible', 'view': 'visible'}
    )
)
...
class ReCulturing(BaseContent):
    security = ClassSecurityInfo()
    implements(IReCulturing, IConstrainTypes)
